...
public class LeftLeaningRBTree {
    
    static private final int RED = 0;
    static private final int BLACK = 1;
    BstNode root;
    ...
    private boolean isRed(BstNode x) { return x.color == RED;}
    ...
    private BstNode flipColor(BstNode node){
        node.color = RED;
